...
from . serializers import ThisUserSerializer, ThisUserUpdateSerializer, CreateReservationSerializer, ListReservationSerializer, UserInfoSerializer
...
class UserInfoRetrieve(RetrieveAPIView):
    ...
    def get_object(self):
        ...
        print("here")
        print(username)
        return get_object_or_404(ThisUser, username=username)
